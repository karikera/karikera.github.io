"use strict";
const __tsb = {
// src\lib\Debug\homeapi.js
homeapi2(){
if(__tsb.homeapi2.exports!=null) return __tsb.homeapi2.exports;
const exports=__tsb.homeapi2.exports={};
var module={exports};
const __tsb_m=module;
const __dirname="/src/lib/Debug";
// include: shell.js
...
// === Body ===
function getClientSize() { var _a, _b; const w = window.innerWidth * ((_a = window.devicePixelRatio) !== null && _a !== void 0 ? _a : 1); const h = window.innerHeight * ((_b = window.devicePixelRatio) !== null && _b !== void 0 ? _b : 1); return (h << 16) | w; }
        ...
        if (typeof setImmediate == 'undefined') {
            ...
            setImmediate = /** @type{function(function(): ?, ...?): number} */ (function Browser_emulated_setImmediate(func) {
                ...
                if (ENVIRONMENT_IS_WORKER) {
                    ...
                    postMessage(emscriptenMainLoopMessageId, "*"); // On the main thread, can just send the message to itself.
            });
        }
...
function setMainLoop(browserIterationFunc, fps, simulateInfiniteLoop, arg, noSetTiming) {
    ...
    if (!noSetTiming) {
        if (fps && fps > 0)
            ...
            _emscripten_set_main_loop_timing(1 /*EM_TIMING_RAF*/, 1); // Do rAF by rendering each frame (no decimating)
        Browser.mainLoop.scheduler();
    }
...
/** @type {function(...*):?} */
var _launchApplication = Module["_launchApplication"] = createExportWrapper("launchApplication");
/** @type {function(...*):?} */
var _lzma_decode = Module["_lzma_decode"] = createExportWrapper("lzma_decode");
/** @type {function(...*):?} */
var _malloc = createExportWrapper("malloc");
/** @type {function(...*):?} */
var _free = createExportWrapper("free");
/** @type {function(...*):?} */
var _lzma_encode = Module["_lzma_encode"] = createExportWrapper("lzma_encode");
/** @type {function(...*):?} */
var _buffer_alloc = Module["_buffer_alloc"] = createExportWrapper("buffer_alloc");
/** @type {function(...*):?} */
var _buffer_free = Module["_buffer_free"] = createExportWrapper("buffer_free");
/** @type {function(...*):?} */
...
var ___start_em_js = Module['___start_em_js'] = 80844;
var ___stop_em_js = Module['___stop_em_js'] = 81001;
...
// include: C:\Users\ME\Desktop\ME\js\homeapi\homeapi\post.js
module.exports = Module;
// end include: C:\Users\ME\Desktop\ME\js\homeapi\homeapi\post.js
return __tsb.homeapi2.exports=__tsb_m.exports;
},
// src\lib\homeapi.ts
homeapi(){
if(__tsb.homeapi.exports!=null) return __tsb.homeapi.exports;
const exports=__tsb.homeapi.exports={};
exports.loadHomeApi = exports.HABuffer = void 0;
const homeapi = __tsb.homeapi2();
const registry = new FinalizationRegistry(ptr => {
    homeapi.asm.buffer_free(ptr);
});
let homeapiProm = null;
class HABuffer {
    constructor(address) {
    ...
    static from(buffer) {
        const out = HABuffer.alloc(buffer.length);
        out.buffer().set(buffer);
        return out;
    }
    static alloc(size) {
        return new HABuffer(homeapi.asm.buffer_alloc(size));
    }
    free() {
        if (this.address === 0)
            return;
        registry.unregister(this);
        homeapi.asm.buffer_free(this.address);
        this.address = 0;
    }
    size() {
        return homeapi.HEAPU32[(this.address >>> 2) - 1];
    }
    buffer() {
        const size = this.size();
        return homeapi.HEAPU8.subarray(this.address, this.address + size);
    }
    lzmaEncode() {
        const encoded = homeapi.asm.lzma_encode(this.address, this.size());
        return new HABuffer(encoded);
    }
    lzmaDecode() {
        const decoded = homeapi.asm.lzma_decode(this.address, this.size());
        return new HABuffer(decoded);
    }
}
exports.HABuffer = HABuffer;
function loadHomeApi() {
    if (homeapiProm !== null)
        return homeapiProm;
    return (homeapiProm = new Promise(resolve => {
        homeapi.addOnInit(resolve);
    }));
}
exports.loadHomeApi = loadHomeApi;
return exports;
},
__resolve(rpath){
return this.__dirname+'/'+rpath;
},
__dirname:location.href,
};
// src\script.ts
const homeapi = __tsb.homeapi2();
const homeapi_1 = __tsb.homeapi();
const canvas = document.createElement('canvas');
canvas.id = 'canvas';
canvas.style.display = 'block';
canvas.style.width = '100%';
canvas.style.height = '100%';
homeapi.canvas = canvas;
...
(async () => {
    await (0, homeapi_1.loadHomeApi)();
    homeapi.asm.launchApplication();
})();
